    ...
    render() {
      ...
      const renderThumbVertical = ({ style, ...props }) => {
        ...
        const thumbStyle = {
          ...
          backgroundColor: ChangeLayoutMode ? 'red' : 'red',
          [left]: '2px',
        };
            ...
            <Layout>
              {!topMenu || window.innerWidth <= 991 ? (
                <ThemeProvider theme={darkTheme}>
                  {this.state.role === 'specialist' && <Sider width={280} style={SideBarStyle} collapsed={collapsed} theme={!darkMode ? 'light' : 'dark'}>
                    <Scrollbars
                    ...
                    >
                      <span className="mainMenuItem">
                        <FeatherIcon icon="chevron-left" size={14} />
                        <p className="sidebar-nav-title">DASHBOARD</p>
                      </span>
                      <MenueItems
              ...
              <Layout className="atbd-main-layout">
                <Content>
                  ...
                  <Footer className="admin-footer" style={footerStyle}>
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="admin-footer__copyright">2021 © Artify.Ai</span>
                      </Col>
                      <Col md={12} xs={24}>
                        <div className="admin-footer__links">
                          <span className="admin-footer__copyright">Artify.Ai</span>
                        </div>
                      </Col>
                    </Row>
                  </Footer>
